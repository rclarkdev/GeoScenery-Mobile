        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Employment = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Scenes_Users_OwnerUserId",
            ...
            migrationBuilder.InsertData(
                table: "Users",
                columns: new[] { "Id", "Bio", "BirthDate", "CreatedAt", "DisplayName", "Education", "Email", "Employment", "Hobbies", "Latitude", "Longitude", "PasswordHash", "ProfileImageUrl" },
                values: new object[] { 1L, null, null, new DateTimeOffset(new DateTime(2026, 9, 22, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)), "Master", null, "vjryanaye@gmail.com", null, null, null, null, "!", null });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Visits_SceneId",
                table: "Visits",
                column: "SceneId");

            migrationBuilder.CreateIndex(
                name: "IX_Visits_UserId_SceneId",
                table: "Visits",
